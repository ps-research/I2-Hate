...
```json
{
  "intent_labels": ["Strategic Incitement", "Ideological Expression"],
  "impact_labels": ["Normalization of Prejudice", "Disruption of Public Discourse", "Misinformation/Disinformation Nexus"]
}
```
...
```json
{
  "intent_labels": ["Ideological Expression", "Affective Aggression"],
  "impact_labels": ["Psychological Harm", "Incitement to Discrimination/Exclusion", "Stigmatization & Dehumanization", "Normalization of Prejudice"]
}
```
...
**Text:** When a country embraces democracy on top of pajeets, gays/tr*ns, marijuana, vaccines, etc; that's how you create the disastrous modern Canada, though hitherto Canada has truly been corrupted since the gay leaf got slapped on in the 60s

**Classification:**
```json
{
  "intent_labels": ["Ideological Expression", "Dominance & Subjugation", "Performative Reinforcement"],
  "impact_labels": ["Psychological Harm", "Stigmatization & Dehumanization", "Normalization of Prejudice", "Incitement to Discrimination/Exclusion", "Disruption of Public Discourse", "Misinformation/Disinformation Nexus"]
}
```
